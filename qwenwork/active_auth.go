// active_auth.go tracks the panel-selected QwenWork account used for routing.
//
// Region is always CN for QwenWork —
...
// pickActiveAuth chooses which QwenWork auth to use from host candidates.
